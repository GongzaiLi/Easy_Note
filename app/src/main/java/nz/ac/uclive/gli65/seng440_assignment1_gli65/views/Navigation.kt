...
import nz.ac.uclive.gli65.seng440_assignment1_gli65.views.screens.MainScreen
...
fun Navigation() {
    ...
    NavHost(navController = navController, startDestination = Screen.MainScreen.route) { // set up start
